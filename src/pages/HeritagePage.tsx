...
export default function HeritagePage() {
   ...
   return (
      <main className="bg-luxury-black min-h-screen selection:bg-gold selection:text-black text-white">
         ...
         <section className="relative h-[60vw] min-h-[360px] md:h-[80vh] lg:h-screen flex items-center justify-center pt-16 md:pt-0 overflow-hidden">
         ...
         <section className="pt-4 pb-16 md:pb-24 container mx-auto px-6 md:px-12 border-b border-white/5">
