      ...
      <div className="container mx-auto px-6 md:px-12 py-16">
        <div className="space-y-6 mb-24">
          ...
          <h1 className="text-6xl md:text-8xl font-serif  tracking-tighter">
            The <span className=" font-display font-medium uppercase text-white/90">Wishlist</span>
          </h1>
        ...
        {favoritedCars.length > 0 ? (
                ...
                <div className="p-8 space-y-6">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <h3 className="text-2xl font-serif  text-white group-hover:text-gold transition-colors">{car.model}</h3>
                    </div>
          ...
          <div className="py-32 text-center space-y-8 border border-white/5 bg-white/[0.01]">
            ...
            <h3 className="text-2xl font-serif  text-white/40">Your wishlist is currently empty.</h3>
            <Link
              to="/inventory"
