...
- Asset Class Preference: ${auditAssetTier}`
   ...
   return (
      <main className="bg-luxury-black min-h-screen selection:bg-gold selection:text-black text-white">
         ...
         <header className="relative h-[55vw] min-h-[320px] md:h-[60vh] flex items-center pt-14 md:pt-20 overflow-hidden">
         ...
         <section className="pt-4 pb-16 md:pb-20 border-b border-white/5">
                  ...
                  <div className="lg:col-span-4 space-y-3">
                     {investmentAssets.map((asset, idx) => (
                        <button
                           ...
                           className={`w-full text-left p-6 border transition-all duration-500 rounded-sm flex justify-between items-center ${selectedAssetIdx === idx
