      ...
      {loading ? null : (
        <>
          ...
          <motion.div style={{ y, scale }} className="absolute inset-0 z-0">
            ...
            <div className={`absolute inset-0 z-20 bg-black flex items-start justify-center pt-20 md:pt-32 transition-opacity duration-1000 ${videoLoaded ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
              <SpeedometerLoader />
            </div>
