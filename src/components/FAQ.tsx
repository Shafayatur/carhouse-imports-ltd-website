        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {list.map((item, idx) => (
              <div
                key={idx}
                className={`border transition-all duration-500 rounded-sm overflow-hidden ${openIndex === idx
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 sm:p-4 md:p-5 px-4 sm:px-5 md:px-6 text-left gap-4 sm:gap-6 outline-none"
                >
                  <h3 className="text-xs sm:text-sm md:text-base font-display uppercase tracking-widest font-bold text-white/90">
                    {item.question}
                  </h3>
                  <div className={`w-8 h-8 rounded-full border flex items-center justify-center shrink-0 transition-all duration-500 ${openIndex === idx
                ...
                >
                  <div className="px-4 sm:px-5 md:px-6 pb-4 sm:pb-5 md:pb-6 border-t border-white/[0.02] pt-3 sm:pt-4">
                    <p className="text-xs sm:text-sm md:text-base text-white/40 leading-relaxed font-light uppercase tracking-widest">
                      {item.answer}
                    </p>
                  </div>
                </motion.div>
