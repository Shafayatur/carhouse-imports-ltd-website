    ...
    <section className="py-32 bg-luxury-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center max-w-4xl mx-auto mb-24">
          ...
          <h2 className="text-6xl md:text-8xl font-serif italic mb-12 leading-tight">
            For Those Who <br />
            <span className="not-italic font-display font-medium text-white uppercase tracking-tighter">Value Exclusivity</span>
          </h2>
        ...
        <div className="mt-32 p-12 md:p-20 bg-gradient-to-br from-luxury-gray to-black border border-gold/20 rounded-md flex flex-col lg:flex-row items-center justify-between gap-12">
           <div className="text-left lg:max-w-2xl">
              <h3 className="text-3xl md:text-4xl font-serif italic mb-6">"Membership is not just a status, it's a direct line to the world's most sought-after machinery."</h3>
