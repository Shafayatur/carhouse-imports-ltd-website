...
export function PartnerLogos() {
  const partners = [
    { name: "Dutton Garage", region: "Melbourne", style: "font-serif font-black tracking-tighter italic" },
    { name: "RM SOTHEBY'S", region: "London / NY", style: "font-serif tracking-[0.3em] font-light" },
    { name: "GIRARDO & CO.", region: "Oxfordshire", style: "font-display font-medium tracking-[0.5em] text-[10px] uppercase" },
    { name: "BINGO SPORTS", region: "Tokyo", style: "font-sans font-black tracking-widest italic scale-y-90 uppercase" },
    { name: "CANEPA", region: "California", style: "font-display font-bold tracking-[0.2em] uppercase" },
    { name: "JOE MACARI", region: "London", style: "font-serif italic font-light tracking-tight" },
    { name: "DANZANTE", region: "Milan", style: "font-sans font-thin tracking-[0.8em] text-[8px] uppercase" },
    { name: "LITTLE CAR CO", region: "United Kingdom", style: "font-display font-black tracking-tight uppercase" }
  ];
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-serif italic text-white tracking-tighter leading-none">
            Our global intelligence spans across the world’s <span className="text-white/40">preeminent specialists.</span>
          </h2>
        </motion.div>
              ...
              {[...partners, ...partners].map((partner, idx) => (
                ...
                >
                  ...
                  <div className="mb-4 md:mb-6 opacity-60 group-hover/card:opacity-100 transition-all duration-700 group-hover/card:scale-105">
                    <span className={`text-base md:text-3xl text-white font-bold block drop-shadow-2xl ${partner.style}`}>
                      {partner.name}
                    </span>
                  </div>
